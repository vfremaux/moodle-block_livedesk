 ...
 * reply_form.php
 * 
 * This file provides post form for reply.
 * Most part of code is hacked from forum/post_form.php to use proper url redirections
 *
 * @package block-livedesk
 * @category blocks
 * @author Wafa Adham <admin@adham.ps>, Valery Fremaux <valery.fremaux@gmail.com>
 * @copyright Jamie Pratt <me@jamiep.org> as per original author of Moodle forum

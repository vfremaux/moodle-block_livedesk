 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_livedesk_reply_form extends moodleform {
    ...
    function definition() {
        ...
        // Useless fir livedesks, livedesk operators usually do not subscribe in local discussions.
        /*
        ...
        */
        // Livedesk operators should send immediately without delay as they cannot reedit answers.
        $mform->addElement('hidden', 'mailnow', 1);
        $mform->setType('mailnow', PARAM_BOOL);

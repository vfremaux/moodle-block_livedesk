...
$string['livedesk:myaddinstance'] = 'Peut ajouter une instance à la page personnalisée';
...
$string['livedesk:updatelivedesk'] = 'Peut modifier un centre support';
...
// Privacy.
$string['privacy:metadata'] = 'Le bloc Centre Support Pédagogique ne détient directement aucune donnée relative aux utilisateurs.';

// Admin settings.
$string['adddeskinstances'] = '+ Créer un nouveau centre';
$string['allusers'] = 'Tous les usagers vérifient les notifications (déconseillé)';
$string['answered'] = 'La demande a été traitée';
...
$string['confignotificationtheme'] = 'Thème de la notification';
$string['confignotificationtheme_desc'] = 'Un choix de feuilles de styles à appliquer aux notifications.';
$string['confignotificationlayout'] = 'Emplacement';
$string['confignotificationlayout_desc'] = 'L\'emplacement des notifications sur l\'écran.';
...
$string['discarded'] = 'La demande a été ignorée';
$string['discardbefore'] = 'Ignorer les messages avant...';
$string['discardbefore_txt'] = 'Ignorer tous les messages avant cette date';
$string['discarddate'] = 'Date';
$string['editdeskinstance'] = 'Modifier une instance de centre support';
$string['emailuser'] = 'Envoyer un message à l\'auteur';
$string['errornoname'] = 'Le nom est vide';
$string['eventlivedeskrun'] = 'Afficher un centre d\'assistance pédagogique';
$string['globalparams'] = 'Réglages globaux';
$string['inprogress'] = 'La demande est en cours';
$string['instancenotboundedtolivedesk'] = 'Ce bloc n\'est actuellement lié à aucune instance de centre support. Il doit être configuré.';
$string['instances'] = 'Instances';
$string['invalidlivedesk'] = 'Instance de support invalide';
$string['keepalivedelay'] = 'Signal de présence';
$string['leaveblanktohide'] = 'Laisser vide pour cacher le titre';
$string['livequeue'] = 'Pile des demandes';
$string['livedesk'] = 'Centre support pédagogique';
$string['livedeskinfo'] = 'Information.';
...
$string['livedeskoperator'] = 'Opérateur de support pédagogique';
$string['livedeskoperator_desc'] = 'Les personnes ayant ce rôle peuvent opérer les centres support pédagogiques';
$string['livedeskref'] = 'Service support associé&nbsp;:&ensp;';
$string['locked'] = 'La demande est verouillée';
$string['lockedby'] = 'Traité par';
$string['managelivedesks'] = 'Gérer les centres supports';
...
$string['messagetime'] = 'Heure d\'émission';
...
$string['messagesinqueue'] = 'Messages dans le centre support&nbsp;:&ensp;{$a} ';
...
$string['newmessage'] = 'Nouvelle demande';
$string['newmessages'] = 'Nouvelles demandes... ';
...
$string['onlineattenderscount'] = 'Opérateurs connectés&nbsp;:&ensp;';
$string['onlineusers'] = 'Utilisateurs connectés';
$string['onlineuserscount'] = 'Utilisateurs connectés&nbsp;:&ensp;';
$string['opened'] = 'La demande a été ouverte';
...
$string['refreshposts'] = 'Raffraichir la liste';
...
$string['topcenter'] = "En haut au centre";
$string['topright'] = "en haut à droite";
$string['center'] = "Au centre";
$string['centerleft'] = "Au centre à gauche";
$string['centerright'] = "Au centre à droite";
$string['bottom'] = "En bas";
$string['bottomleft'] = "En bas à gauche";
$string['bottomcenter'] = "En bas au centre";

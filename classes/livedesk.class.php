...
class livedesk {
    ...
    */  
    ...
    public static function get_unnotified_messages() {
        ...
        if (!isset($CFG->block_livedesk_notification_backtrack_range)) {
            set_config('block_livedesk_notification_backtrack_range', 50);
        }

        // Get the running livedesks.
        $livedesks_arr = self::get_running_livedesks($USER->id, $CFG->block_livedesk_notification_backtrack_range);

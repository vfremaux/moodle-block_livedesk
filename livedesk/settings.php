...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtime('block_livedesk_desk_service_timerangestart_h_start','block_livedesk_desk_service_timerangestart_m_start', get_string('block_livedesk_desk_service_timerange_start', 'block_livedesk'),
                   get_string('block_livedesk_desk_service_timerange_start_comment', 'block_livedesk'),null));
    
    $settings->add(new admin_setting_configtime('block_livedesk_desk_service_timerangestart_h_end','block_livedesk_desk_service_timerangestart_m_end', get_string('block_livedesk_desk_service_timerange_end', 'block_livedesk'),
                   get_string('block_livedesk_desk_service_timerange_end_comment', 'block_livedesk'),null));               
}

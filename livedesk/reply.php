 ...
 */
    ...
    if (!empty($forum)) {      // User is starting a new discussion in a forum
            ...
            if ($post->totalscore) {
                ...
                if (! $post->parent) {  // post is a discussion topic as well, so delete discussion
                    ...
                    if ($forum->type == 'single') {
                        ...
                        $discussionurl = "reply.php?d=$post->discussion&replydone=1&plugininstance=".$plugininstance;
                    }
        ...
        if (!empty($name) && confirm_sesskey()) {    // User has confirmed the prune
            ...
            redirect(forum_go_back_to("reply.php?d=$newid"));
    ...
    if ($fromform = $mform_post->get_data()) {
        ...
        if ($fromform->edit) {           // Updating a post
            ...
            if ($forum->type == 'single') {
                ...
                $discussionurl = "reply.php?d=$discussion->id#p$fromform->id&replydone=1&plugininstance=".$plugininstance;
            }
            ...
            if ($fromform->id = forum_add_new_post($addpost, $message)) {
                ...
                if ($forum->type == 'single') {
                    ...
                    $discussionurl = "reply.php?d=$discussion->id&replydone=1&plugininstance=".$plugininstance;
                }

    ...
    livedesk = {
        ...
        init: function(params) {
            ...
            str.get_strings(stringdefs).done(function(s) {
                ...
                livedesk.mygrid.setHeader("#,," + livedesk.strs[4] + "," + livedesk.strs[5] + "," + livedesk.strs[6] + "," + livedesk.strs[7] + "," + livedesk.strs[8]); // Set column names.
         ...
         */
        onContextMenuClick: function(id, zoneId, casState) {
            var selId;
            ...
            switch (id) {
                ...
                case 'discard_post': {
                    livedesk.discard_post(selectedRow);
                    break;
                }

                case 'discard_posts_before': {
                    var timecreated = livedesk.mygrid.getUserData(selectedRow, 'timecreated');
                    discard_messages_window = livedesk.dhxWins.createWindow('discard_messages', 400, 100, 400, 130);
        ...
        * Event Handlers
        */
        onBeforeContextMenuHandler: function (id, ind, obj) {
        ...
        */
        toolbarClickHandler: function (item, event) {
            var url;
        ...
        */
         ...
         */
        generateNoty: function (text, type, extraparam) {
            var n = noty({
                text: text,
                timeout: 5000,
                closeWith: ['button'],
        ...
        getMonitoredPlugins: function () {
            ...
            $.post(url, function(data) {
                ...
                for (key in data) {
                    ...
                    htmlbuffer += "<a target=\"_blank\" href=\"" + cfg.wwwroot + "/mod/forum/view.php?id=" + data[key].cmid + "\" > ";
        ...
        discard_post: function() {
            var postid = livedesk.mygrid.getUserData(selectedRow, 'messageid');
            var url = cfg.wwwroot + '/blocks/livedesk/ajax/service.php?';
